...
def create_nodes():
    ...
    nodes = {
        ...
        'OHF steel': ProcessGroup(['OHF steel'], title='OHF steel'),
        ...
        'Waste': ProcessGroup(['Waste'], title='Waste'),
...
def create_bundles():
    ...
    bundles = [
        ...
        Bundle('OHF steel', 'Ingots and semis'),
        ...
        Bundle('Scrap steel', 'Waste', waypoints=['Loss_way1', 'Loss_way2']),
        Bundle('Pig iron', 'Waste', waypoints=['Loss_way2']),
        Bundle('DRI', 'Waste', waypoints=['Loss_way2']),
        Bundle('BOF steel', 'Waste'),
        Bundle('OHF steel', 'Waste'),
        Bundle('EAF steel', 'Waste'),
...
def create_ordering():
    ...
    [['Imports of ingots and semis'],['BOF steel','OHF steel','EAF steel'],['Loss_way2'],[],['Exports of pig and DRI']],
    [['Imports of long and flat'],['Ingots and semis'],['Waste'],[],[]],
